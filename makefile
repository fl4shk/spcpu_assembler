...
# Edit these variables if more directories are needed.  Order is C++, (GNU) ASM, NASM.
...
OFILES:=$(CXX_OFILES) $(S_OFILES) $(NS_OFILES)
...
PFILES:=$(CXX_PFILES) $(S_PFILES) $(NS_PFILES)
...
OFILES_TEMP:=$(CXX_OFILES_TEMP) $(S_OFILES_TEMP) $(NS_OFILES_TEMP)
